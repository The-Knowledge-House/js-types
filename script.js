...
for (let i = 0; i < q9.length; i++) {
  period_removed[i] = q9[i].split('.').join("")
}

const q11 = period_removed;
...
for (let i = 0; i < q11.length; i++) {
  words_length[i] = q11[i].length
}

const q12 = words_length;
...
let words_length_avg = total / q12.length;

const q13 = words_length_avg;

...
const removeDot = address.split(" ");
for (let i = 0; i < removeDot.length; i++) {
  removeDot[i] = removeDot[i].replace(/\./g, '');
}
const q11 = removeDot;
 ...
 */
 ...
 let GAaverage = GBTotal / q12.length;

 ...
 */
const q3 = "Every Villain is Lemons";
 ...
 */
const q12 = address;
let result = q12.split(" ");
const array = result.map(function(word)
  {return word.length})
console.log (array)
/**
 * QUESTION 13
 ...
 */
const q13 = array;
let average = array.join('').length / array.length;
console.log(average)

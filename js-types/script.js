 ...
 */
const q7 = str.toUppercase(address);

/**
 * QUESTION 8
 * Assign the number of characters in the Gettysburg Address
 */
const q8 = str.length(address);
 ...
 */
const q12 = str.split(q11, " ").length; 

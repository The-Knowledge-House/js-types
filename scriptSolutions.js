 ...
 */
var wordLengths = [q11.length];
for (var i = 0; i < q11.length; i++)
{
  wordLengths[i] = q11[i].length;
  }
const q12 = wordLengths; 
...
{
  sumOfWordLengths += q12[i];
}
const q13 = sumOfWordLengths / q12.length;
